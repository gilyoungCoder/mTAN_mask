...
if __name__ == '__main__':
    ...
    for itr in range(1, args.niters + 1):
        train_recon_loss, train_ce_loss, train_reg_loss, train_q_loss = 0, 0, 0, 0
        mse = 0
        train_n = 0
        train_acc = 0
        ...
        for train_batch, label in train_loader:
            ...
            q_loss = utils.quantization_loss(mask)
            ...
            train_q_loss += q_loss.item() * batch_len
        ...
        cur_q_loss = args.gamma*train_q_loss/train_n
        print('Iter: {}, recon_loss: {:.4f}, ce_loss: {:.4f}, reg_loss: {:.4f}, q_loss: {:.4f}, acc: {:.4f}, mse: {:.4f}, val_loss: {:.4f}, val_acc: {:.4f}, test_acc: {:.4f}, test_auc: {:.4f}'
              .format(itr, train_recon_loss/train_n, args.alpha*train_ce_loss/train_n, cur_reg_loss, cur_q_loss,
